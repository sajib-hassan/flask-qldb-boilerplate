...
def create_qldb_driver(ledger_name=config.LEDGER_NAME, region_name=None, endpoint_url=None, boto3_session=None):
    """
...
def create_qldb_session(ledger_name=config.LEDGER_NAME):
    """
