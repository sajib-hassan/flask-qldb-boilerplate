...
#         s3_bucket_name = "{}-{}".format(config.JOURNAL_EXPORT_S3_BUCKET_NAME_PREFIX, identity['Account'])
#
#     create_s3_bucket_if_not_exists(s3_bucket_name, s3_resource)
#
#     s3_encryption_config = set_up_s3_encryption_configuration(kms_arn)
#
#     export_result = create_export_and_wait_for_completion(config.LEDGER_NAME, s3_bucket_name,
#                                                           config.LEDGER_NAME + '/',
