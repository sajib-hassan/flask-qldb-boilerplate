...
from hash_chain.app.modules.ledger.core.journal_block import from_ion
...
def compare_key_with_content_range(file_key, first_block, last_block):
    ...
    :type first_block: :py:class:`hash_chain.ledger.qldb.journal_block.JournalBlock`
    :param first_block: The first block in the block chain for a particular journal strand.

    :type last_block: :py:class:`hash_chain.ledger.qldb.journal_block.JournalBlock`
